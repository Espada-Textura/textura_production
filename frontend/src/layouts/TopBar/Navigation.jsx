      ...
      <ul className={"topbar-navigation-bar gap-6"}>
        ...
        <li>
          <NavLink to={"/discover"} className={"topbar-nav-link max-xl:p-3"}>
            ...
            <FiCompass className="lg:hidden w-8 h-8" />
          </NavLink>
        </li>
        ...
        <li>
          <NavLink to={"/challenges"} className={"topbar-nav-link max-xl:p-3"}>
            ...
            <HiOutlinePuzzle className="lg:hidden w-8 h-8" />
          </NavLink>
        </li>
        ...
        <li>
          <NavLink to={"/forum"} className={"topbar-nav-link max-xl:p-3"}>
            ...
            <HiOutlineChatAlt2 className="lg:hidden w-8 h-8" />
          </NavLink>
        </li>
      </ul>
    </nav>
