    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          key="twitter:image"
          content={`https://web.textura-art.com/api/art/${aid}_thumbnail..jpeg`}
        />
        <meta
          property="og:image"
          key="og:image"
        ...
        <meta
          ...
          content="Textura is a community, for our Cambodian Artists to share their arts, earn recognition, express feeling and emotion through art, and more importantly is to improve the artist community in Cambodia."
        />
