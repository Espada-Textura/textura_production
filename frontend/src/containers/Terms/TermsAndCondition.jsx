const TermsAndCondition = () => {
  return (
    <div className="terms-container p-16">
      ...
      <div className="text-base font-normal my-2">
        The Textura website located at{" "}
        <a
          className="text-accent-100"
          href="https://www.textura-art.com"
          target="_blank"
        >
          https://www.textura-art.com
        </a>{" "}
        is a copyrighted work belonging to Espada Team. Certain features of the
      ...
      <div className="text-lg font-semibold my-3">Access to the Site</div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Subject to these Terms.</strong>{" "}
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Certain Restrictions.</strong> The
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">No Support or Maintenance.</strong>{" "}
      ...
      <div className="text-lg font-semibold my-3">User Content</div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">User Content.</strong> "User Content"
        means any and all information and content that a user submits to the
        Site. You are exclusively responsible for your User Content. You bear
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Acceptable Use Policy.</strong> The
        following terms constitute our "Acceptable Use Policy": You agree not to
        use the Site to collect, upload, transmit, display, or distribute any
        User Content (i) that violates any third-party right or any intellectual
        property or proprietary right; (ii) that is unlawful, harassing,
        abusive, tortious, threatening, harmful, invasive of another's privacy,
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Third-Party Links & Ads.</strong> The
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Other Users.</strong> Each Site user
        is solely responsible for any and all of its own User Content. Because
        we do not control User Content, you acknowledge and agree that we are
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Cookies and Web Beacons.</strong> Like
        any other website, TEXTURA uses 'cookies'. These cookies are used to
      ...
      <div className="text-lg font-semibold my-3">Disclaimers</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-lg font-semibold my-3">Limitation on Liability</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Term and Termination.</strong> Subject
        ...
        the Site will terminate immediately. You understand that any termination
      ...
      <div className="text-lg font-semibold my-3">Copyright Policy.</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-normal my-2">
        <ul>
          <li className="my-2">your physical or electronic signature;</li>
          <li className="my-2">
      ...
      <div className="text-lg font-semibold my-3">General</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-normal my-2">
        ...
        Company should be sent to: Phnom Penh, Cambodia. After the Notice is
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Arbitration Rules.</strong>{" "}
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Time Limits.</strong> If you or the
        Company pursues arbitration, the arbitration action must be initiated
        and/or demanded within the statute of limitations and within any
        deadline imposed under the AAA Rules for the pertinent claim.
      </div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Authority of Arbitrator.</strong> If
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Waiver of Jury Trial.</strong> THE
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Confidentiality.</strong> All aspects
        of the arbitration proceeding shall be strictly confidential. The
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Severability.</strong> If any part or
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Right to Waive.</strong> Any or all of
        the rights and limitations set forth in this Arbitration Agreement may
        be waived by the party against whom the claim is asserted. Such waiver
        shall not waive or affect any other portion of this Arbitration
        Agreement.
      </div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Survival of Agreement.</strong> This
        Arbitration Agreement will survive the termination of your relationship
        with Company.
      </div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Small Claims Court.</strong>{" "}
        Nonetheless the foregoing, either you or the Company may bring an
        individual action in small claims court.
      </div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Emergency Equitable Relief.</strong>{" "}
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Electronic Communications.</strong>{" "}
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Entire Terms.</strong> These Terms
      ...
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">Your Privacy.</strong> Please read our
        Privacy Policy.
      </div>
      <div className="text-base font-normal my-2">
        <strong className="font-semibold">
      ...
      <div className="text-lg font-semibold my-3">Contact Information</div>
      <div className="text-base font-normal my-2">
        Address: Phnom Penh, Cambodia
      </div>
      <div className="text-base font-normal my-2">
        Email: espada-team@gmail.com
      </div>
    </div>
  );
};
