const PrivacyPolicy = () => {
  return (
    <div className="privacy-container p-16">
      ...
      <div className="text-lg font-semibold my-3">Interpretation</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-lg font-semibold my-3">Definitions</div>
      <div className="text-base font-normal my-2">
        ...
        <ul>
          ...
          <li>
            <div className="my-2">
              ...
              &quot;Our&quot; in this Agreement) refers to Espada Team, Phnom
              Penh, Cambodia.
            </div>
          </li>
          <li>
          ...
          <li>
            <div className="my-2">
              ...
              TEXTURA, accessible from{" "}
              <a
                className="text-accent-100"
                href="https://textura-art.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://textura-art.com/
              </a>
            </div>
          </li>
          <li>
      ...
      <div className="text-lg font-semibold my-3">Types of Data Collected</div>
      <div className="text-base font-semibold my-2">Personal Data</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-semibold my-2">Usage Data</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-normal my-2">
        <ul>
          <li className="my-2">
            ...
            <div className="my-2">Type: Session Cookies</div>
            <div className="my-2">Administered by: Us</div>
            <div className="my-2">
          ...
          <li className="my-2">
            ...
            <div className="my-2">Type: Persistent Cookies</div>
            <div className="my-2">Administered by: Us</div>
            <div className="my-2">
      ...
      <div className="text-base font-semibold my-2">Business Transactions</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-semibold my-2">Law enforcement</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-xl font-bold my-4">Children's Privacy</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-xl font-bold my-4">Links to Other Websites</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-xl font-bold my-4">Contact Us</div>
      <div className="text-base font-normal my-2">
      ...
      <div className="text-base font-normal my-2">
        <ul>
          <li className="my-3">
            <div>By email: espada-team@gmail.com</div>
          </li>
          <li className="my-3">
            <div>
              ...
              <a
                className="text-accent-100"
                href="https://textura-art.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://textura-art.com/contact
              </a>
            </div>
          </li>
        </ul>
