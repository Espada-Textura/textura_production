...
const RecoveryPassword = () => {
  return (
    <div className="recovery-password-container bg-[url(/src/images/sign-up.png)] bg-auto bg-no-repeat bg-center w-full h-screen md:p-14 flex justify-center items-center">
